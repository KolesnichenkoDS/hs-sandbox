...
--  fromEnum BoolColumn = 16
--  fromEnum ByteaColumn = 17
--  fromEnum CharColumn = 18
--  fromEnum NameColumn = 19
--  fromEnum Int2Column = 21
--  fromEnum Int4Column = 23
--  fromEnum Int8Column = 20
--  fromEnum TextColumn = 25
--  fromEnum VarcharColumn = 1043
--  fromEnum (UnknownColumn x) = fromIntegral x
